...
static const QHash<QString, ResourceClass> RESOURCE_CLASS_STRINGIFIED = {
...
static const QHash<QString, BundleType> BUNDLE_TYPE_STRINGIFIED = {
...
static const QHash<int, ResourceOrientation> RESOURCE_FLIP_NUMERICAL = {
...
static const QHash<QString, ComponentType> COMPONENT_TYPE_STRINGIFIED = {
...
static const QHash<QString, MediaUnit> MEDIA_UNIT_STRINGIFIED = {
    {"Continuous", MediaUnit::ContinuousMediaUnit},
    {"Roll", MediaUnit::RollMediaUnit},
    {"Sheet", MediaUnit::SheetMediaUnit}
};

static const QHash<QString, MediaType> MEDIA_TYPE_STRINGIFIED = {
...
static const QHash<QString, DeviceStatus> DEVICE_STATUS_STRINGIFIED = {
